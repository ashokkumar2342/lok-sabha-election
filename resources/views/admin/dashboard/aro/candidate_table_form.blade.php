 ...
 Booth No : <strong>{{ $boothDetail->booth_no }}</strong>, 
  @if ($countingTableBoothMap->status==1) 
   <span style="float:right;">
     ...
     <a target="blank" href="{{ route('report.download',[$countingTableBoothMap->pc_code,$countingTableBoothMap->ac_code,$countingTableBoothMap->round_no,$countingTableBoothMap->table_no]) }}" class="btn btn-success .d-none .d-sm-block">
